...
if (\version_compare($wp_version, \RTG_MIN_WP, '>=')) {
    ...
    if ($load_core) {
        ...
        $composer_autoload_path = \path_join(\RTG_PATH, 'vendor/autoload.php');
        $composer_scoper_autoload_path = \path_join(\RTG_PATH, 'vendor/scoper-autoload.php');
        ...
        new \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\Freemium\Autoloader('RTG');
        \DevOwl\RealThumbnailGenerator\Core::getInstance();
    } else {
