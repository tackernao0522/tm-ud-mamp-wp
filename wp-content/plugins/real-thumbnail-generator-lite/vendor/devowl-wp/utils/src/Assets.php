    ...
    public function localizeScript($context) {
        ...
        return [
            ...
            'restUrl' => $this->getAsciiUrl(
                \DevOwl\RealThumbnailGenerator\Vendor\MatthiasWeb\Utils\Service::getUrl($this)
            ),
            'restNamespace' => \DevOwl\RealThumbnailGenerator\Vendor\MatthiasWeb\Utils\Service::getNamespace($this),
...
',
    ...
    public function getChunkTranslationMap() {
        $inc = $this->getPluginConstant(
            \DevOwl\RealThumbnailGenerator\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_INC
        );
