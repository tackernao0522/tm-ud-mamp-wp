...
abstract class AbstractInitiator {
    ...
    public function start() {
        \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealUtils\Core::getInstance()->addInitiator($this);
        $this->welcomePage = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealUtils\WelcomePage::instance($this);
