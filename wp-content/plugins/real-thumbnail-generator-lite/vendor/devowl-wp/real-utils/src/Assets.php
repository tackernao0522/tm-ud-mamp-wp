...
class Assets {
    ...
    public function overrideLocalizeScript($context) {
        $ratingHandler = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealUtils\Core::getInstance()->getRatingHandler();
        ...
        return [
            ...
            'cross' => \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealUtils\Core::getInstance()
    ...
    public static function instance() {
        return new \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealUtils\Assets();
    }
}
