...
use DevOwl\RealThumbnailGenerator\Vendor\Puc_v4p4_Plugin_UpdateChecker;
use DevOwl\RealThumbnailGenerator\Vendor\Puc_v4_Factory;
use WP_Error;
...
class PluginUpdateChecker {
    ...
    public function probablyEnableExternalUpdates() {
        ...
        $puc = \DevOwl\RealThumbnailGenerator\Vendor\Puc_v4_Factory::buildUpdateChecker(
    ...
    public function validateResult($response) {
        ...
        if ($license !== \false) {
            $parsedError = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\client\ClientUtils::parseResponse(
                $response
            );
    ...
    public static function instance($pluginUpdate) {
        return new \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\license\PluginUpdateChecker(
            $pluginUpdate
        );
    }
}
