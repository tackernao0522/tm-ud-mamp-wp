...
class License {
    ...
    public function __construct($slug, $blogId) {
        $this->slug = $slug;
        $this->blogId = $blogId;
        $this->activation = new \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\license\LicenseActivation(
            $this
        );
    ...
    public function syncWithRemote() {
        ...
        if (empty($code)) {
            return new \WP_Error(
                \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\license\License::ERROR_CODE_NOT_ACTIVATED,
    ...
    public function update_option_siteurl() {
        $currentHostname = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\Utils::getCurrentHostname();
    ...
    public function validateNewHostName() {
        ...
        if (
            !\DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\Utils::isRedirected() &&
            $isLicensed &&
    ...
    public function validateRemoteResponse($response) {
        ...
        if (
            ...
            $response->get_error_code() ===
                \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\client\ClientUtils::ERROR_CODE_REMOTE
        ) {
    ...
    public function getInitiator() {
        return \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\Core::getInstance()->getInitiator(
            $this->getSlug()
        );
    }
    /**
    ...
    public function getAsArray() {
        ...
        $this->switch();
        $host = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\Utils::getCurrentHostName();
        $this->restore();
        return [
            'blog' => $this->getBlogId(),
            'host' => $host,
