...
class Assets {
    ...
    public function overrideLocalizeScript($context) {
        ...
        $names = [];
        foreach (
            \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\Core::getInstance()->getInitiators()
            as $initiator
        ) {
        ...
        return [
            'currentUserFullName' => \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\Utils::getUserFullName(),
            'names' => $names
        ];
    }
    /**
    ...
    public static function instance() {
        return new \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\Assets();
    }
}
