...
abstract class AbstractInitiator {
    ...
    public function getPluginUpdater() {
        if ($this->pluginUpdate === null) {
            $this->pluginUpdate = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\PluginUpdate::instance(
                $this
            );
        }
    ...
    public function start() {
        \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\Core::getInstance()->addInitiator(
            $this
        );
    }
    // Self-explaining
