...
class PluginUpdate {
    ...
    private function __construct($initiator) {
        ...
        $this->view = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\view\PluginUpdateView::instance(
            $this
        );
        $this->announcementPool = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\announcement\AnnouncementPool::instance(
            $this
        );
        $this->pluginUpdateChecker = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\license\PluginUpdateChecker::instance(
            $this
        );
    ...
    public static function instance($initiator) {
        return new \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\PluginUpdate($initiator);
    }
}
