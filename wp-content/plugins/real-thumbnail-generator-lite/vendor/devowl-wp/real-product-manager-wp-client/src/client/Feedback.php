...
class Feedback {
        ...
        return \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\client\ClientUtils::request(
            ...
            [
                'deactivationFeedback' => [
                    ...
                    'ip' => empty($email)
                        ? null
                        : \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\Utils::getIpAddress(),
                    'name' => $name
                ]
            ],
            'POST'
    ...
    public static function instance($pluginUpdate) {
        return new \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\client\Feedback(
            $pluginUpdate
        );
    }
}
