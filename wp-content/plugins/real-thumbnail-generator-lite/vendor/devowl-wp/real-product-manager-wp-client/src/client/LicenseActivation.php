...
class LicenseActivation {
    ...
    public function post(
        ...
        $ip = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\Utils::getIpAddress();
        ...
        return \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\client\ClientUtils::request(
    ...
    protected function getClientProperties() {
        return [
            [
                'key' => 'hostname',
                'value' => \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\Utils::getCurrentHostname()
            ],
    ...
    public static function instance($pluginUpdate) {
        return new \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\client\LicenseActivation(
            $pluginUpdate
        );
    }
}
