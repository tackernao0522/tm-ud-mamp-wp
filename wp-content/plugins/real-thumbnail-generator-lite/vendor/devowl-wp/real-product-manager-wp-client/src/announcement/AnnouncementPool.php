...
class AnnouncementPool {
    ...
    private function __construct($pluginUpdate) {
        ...
        $this->view = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\view\AnnouncementView::instance(
            $this
        );
        $this->option = new \DevOwl\RealThumbnailGenerator\Vendor\MatthiasWeb\Utils\ExpireOption(
            self::OPTION_NAME . '_' . $pluginUpdate->getInitiator()->getPluginSlug(),
            is_multisite(),
            self::OPTION_EXPIRE
        );
        $this->client = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\client\Announcement::instance(
            $pluginUpdate
        );
    }
    /**
        ...
        if ($this->items === null) {
            ...
            if (isset($value['items'])) {
                foreach ($value['items'] as $row) {
                    $this->items[] = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\announcement\Announcement::fromResponse(
                        $this,
                        $row
                    );
                }
    ...
    public static function instance($pluginUpdate) {
        return new \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\announcement\AnnouncementPool(
            $pluginUpdate
        );
    }
}
