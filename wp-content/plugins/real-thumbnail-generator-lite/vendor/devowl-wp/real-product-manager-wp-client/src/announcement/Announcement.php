...
class Announcement {
    ...
    public function isVisible() {
        return $this->getVisibility() ===
            \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\announcement\Announcement::VISIBILITY_LOCAL
            ? $this->getPool()
                ->getPluginUpdate()
                ->getInitiator()
    ...
    public static function fromResponse($pool, $response) {
        return new \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\announcement\Announcement(
            $pool,
            $response['id'],
