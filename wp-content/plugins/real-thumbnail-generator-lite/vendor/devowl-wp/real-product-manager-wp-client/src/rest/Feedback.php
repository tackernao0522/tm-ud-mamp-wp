...
class Feedback {
    ...
    public function routePost($request) {
        ...
        $initiator = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\Core::getInstance()->getInitiator(
            $slug
        );
        if ($initiator === null) {
            ...
            $result = \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\client\Feedback::instance(
    ...
    public static function instance() {
        return new \DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\rest\Feedback();
    }
}
